...
SET statement_SET xmloption = content;
timeout = 0;
SET lock_timeout = 0;
...
--
-- Name: galaxy_id; Type: TABLE; Schema: public; Owner: freecodecamp
--

CREATE TABLE public.galaxy_id (
    galaxy_id integer NOT NULL,
    speed integer,
    description text
);
...
--
-- Name: galaxy_id_galaxy_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.galaxy_id_galaxy_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.galaxy_id_galaxy_id_seq OWNER TO freecodecamp;

--
-- Name: galaxy_id_galaxy_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.galaxy_id_galaxy_id_seq OWNED BY public.galaxy_id.galaxy_id;
...
--
-- Name: galaxy_id galaxy_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.galaxy_id ALTER COLUMN galaxy_id SET DEFAULT nextval('public.galaxy_id_galaxy_id_seq'::regclass);
...
--
-- Data for Name: galaxy_id; Type: TABLE DATA; Schema: public; Owner: freecodecamp
--
...
--
-- Name: galaxy_id_galaxy_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.galaxy_id_galaxy_id_seq', 1, false);
...
--
-- Name: galaxy_id galaxy_id_pkey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.galaxy_id
